        ...
        init: function () {
            ...
            $(e.element).each( function(i,o) {
                ...
                $(o).find("tr").not(e.settings.exclude).each(function (i,o) {
                    tempRows += "<tr>"
                    $(o).children("*").not(e.settings.exclude).each(function (tdKey, tdObj) {
                        tempRows+=$(tdObj).prop('outerHTML');
                    });
                    tempRows += "</tr>";
                });
...
$(function () {
    $('body').on('click','.table2excel',function () {
        var table = $(this).parents('table').eq(0);
        var excelName = table.data('name');
        excelName = excelName==undefined||excelName==''?'tableExcel':excelName;
        table.table2excel({
            exclude: ".noExl",
            name: excelName,
            filename: excelName,
