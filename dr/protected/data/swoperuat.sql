...
--
-- Host: localhost    Database: swoperuat
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=67135 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `swo_monthly_dtl` (
  ...
  `lud` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=28772 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `swo_service` (
  ...
  KEY `idx_swo_service_2` (`city`,`status_dt`)
) ENGINE=InnoDB AUTO_INCREMENT=14015 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'swoperuat'
--
...
-- Dump completed on 2018-05-14 15:18:29
