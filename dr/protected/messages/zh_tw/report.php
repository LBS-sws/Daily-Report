...
'Email Cc'=>'電郵抄送',
'For Feedback'=>'用於回饋',
'Please find the attached report file for your reference.'=>'請參閱所附的報表文件以供參考.',
'Please fill in Feedback on All Daily Reports (Date: {date})'=>'請填寫日報表總匯(日期: {date})的回饋',
'Please click <a href="{url}">here</a> to go to system to feedback All Daily Reports.'=>'請點擊<a href="{url}">這裡</a>進入系統以作日報表總彙的回饋',
...
"Please click <a href=\"{fburl}\" onClick=\"return popup(this,'Daily Report');\">here</a> to go to system to feedback All Daily Reports."=> "請點擊<a href=\"{fburl}\" onClick=\"return popup(this,'Daily Report');\">這裡</a>進入系統以作日報表總彙的回饋",
'Dear All'=>'各位',
'Also'=>'另外',
'user'=>'用戶',
