<?php
$this->pageTitle=Yii::app()->name . ' - CrossAudit Form';
?>
...
$this->widget('bootstrap.widgets.TbModal', array(
    ...
    'content'=>$content,
    'footer'=>array(
        TbHtml::button(Yii::t('dialog','OK'), array('color'=>TbHtml::BUTTON_COLOR_PRIMARY,'submit'=>Yii::app()->createUrl('crossAudit/reject'))),
