<?php
$this->pageTitle=Yii::app()->name . ' - Outsource Form';
?>
...
<section class="content-header">
	<h1>
        <strong><?php echo Yii::t('app','Outsource'); ?></strong>
                ...
                <div class="box-body" >
                    <div class="col-lg-5">
                        <div class="form-group">
                            ...
                            <div class="col-lg-7">
                                <?php echo $form->inlineRadioButtonList($model, 'search_type',OutsourceForm::getSelectType(),
                    ...
                    $tabs =array();
                    $contentTable = str_replace("{:head:}",Yii::t("app","Outsource"),$contentHead);
                    $contentTable.=$model->outsourceHtml();
                    $contentTable.=$contentEnd;
                    $tabs[] = array(
                        'label'=>Yii::t("app","Outsource"),
                        'content'=>$contentTable,
                        'active'=>true,
                    );//外包数据分析
                    $contentTable = str_replace("{:head:}",Yii::t("summary","Outsource productivity"),$contentHead);
                    $contentTable.=$model->outsourceHtml(2);
                    $contentTable.=$contentEnd;
                    //$contentTable.=TbHtml::hiddenField("excel[two]",$areaModel->downJsonText);
                    $tabs[] = array(
                        'label'=>Yii::t("summary","Outsource productivity"),
                        'content'=>$contentTable,
                        'active'=>false,
                    );//外包人员生产力
...
";
$ajaxUrl = Yii::app()->createUrl('outsource/ajaxDetail');
$js.= "
