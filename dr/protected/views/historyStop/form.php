<?php
$this->pageTitle=Yii::app()->name . ' - HistoryStop Form';
?>
...
<section class="content-header">
	<h1>
        <strong><?php echo Yii::t('app','History Stop'); ?></strong>
                        ...
                        <div class="row panel panel-default" style="border-color: #333">
                            ...
                            <div class="panel-heading">
                                <h3 style="margin-top:10px;">
                                    <?php echo Yii::t('app','History Stop'); ?>
                            ...
                            <div class="table-responsive">
                                <?php echo $model->historyStopHtml();?>
                            </div>
                        </div>
                    </div>
                </div>
...
$js="
    $('.click-th').click(function(){
        ...
        if($(this).hasClass('active')){
            ...
            $('#historyStop>thead>tr').eq(0).children().slice(startNum,endNum).each(function(){
                var width = $(this).data('width')+'px';
                $(this).width(width);
            });
            $('#historyStop>thead>tr').eq(2).children().slice(startNum-contNum,endNum-contNum).each(function(){
                $(this).children('span').text($(this).data('text'));
            });
            $('#historyStop>tbody>tr').each(function(){
