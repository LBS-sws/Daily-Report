<?php
$this->pageTitle=Yii::app()->name . ' - Product Form';
?>
...
<section class="content-header">
	<h1>
		<strong><?php echo Yii::t('app','Pay Week'); ?></strong>
	</h1>
<!--
	<ol class="breadcrumb">
		...
		<?php 
			if ($model->scenario!='new' && $model->scenario!='view') {
				echo TbHtml::button('<span class="fa fa-file-o"></span> '.Yii::t('misc','Add Another'), array(
					'submit'=>Yii::app()->createUrl('payWeek/new')));
			}
		?>
		<?php echo TbHtml::button('<span class="fa fa-reply"></span> '.Yii::t('misc','Back'), array(
				'submit'=>Yii::app()->createUrl('payWeek/index')));
		?>
<?php if ($model->scenario!='view'): ?>
			<?php echo TbHtml::button('<span class="fa fa-upload"></span> '.Yii::t('misc','Save'), array(
				'submit'=>Yii::app()->createUrl('payWeek/save')));
			?>
<?php endif ?>
...
<?php
$js = Script::genDeleteData(Yii::app()->createUrl('payWeek/delete'));
