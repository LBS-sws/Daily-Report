<?php
$this->pageTitle=Yii::app()->name . ' - SalesMonthCount Form';
?>

<?php $form=$this->beginWidget('TbActiveForm', array(
'id'=>'salesMonthCount-form',
...
<section class="content-header">
	<h1>
        <strong><?php echo Yii::t('app','Sales Month Count'); ?></strong>
...
<section class="content">
	...
	<div class="btn-group" role="group">
		<?php echo TbHtml::button('<span class="fa fa-reply"></span> '.Yii::t('misc','Back'), array(
				'submit'=>Yii::app()->createUrl('salesMonthCount/index')));
		?>
	</div>
            <div class="btn-group pull-right" role="group">
                <?php echo TbHtml::button('<span class="fa fa-download"></span> '.Yii::t('dialog','Download'), array(
                    'submit'=>Yii::app()->createUrl('salesMonthCount/downExcel',array('type'=>'stop'))));
                ?>
            </div>
	</div></div>
                ...
                <div class="box-body" >
                    <div class="col-lg-5">
                        <div class="form-group">
                            <?php echo $form->labelEx($model,'search_year',array('class'=>"col-sm-5 control-label")); ?>
                            <div class="col-sm-7">
                        ...
                        <div class="row panel panel-default" style="border-color: #333">
                            ...
                            <div class="panel-heading">
                                <h3 style="margin-top:10px;">
                                    <?php echo Yii::t('app','Sales Month Count'); ?>
                            ...
                            <div class="table-responsive">
                                <?php echo $model->salesMonthCountHtml();?>
                            </div>
                        </div>
                    </div>
                </div>
...
$js="
    $('.click-th').click(function(){
        ...
        if($(this).hasClass('active')){
            ...
            $('#salesMonthCount>thead>tr').eq(0).children().slice(startNum,endNum).each(function(){
                var width = $(this).data('width')+'px';
                $(this).width(width);
            });
            $('#salesMonthCount>thead>tr').eq(2).children().slice(startNum-contNum,endNum-contNum).each(function(){
                $(this).children('span').text($(this).data('text'));
            });
            $('#salesMonthCount>tbody>tr').each(function(){
