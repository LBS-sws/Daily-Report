...
<section class="content-header">
	<h1>
        <strong><?php echo Yii::t('app','Bonus Month'); ?></strong>
                ...
                <div class="box-body" >
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <?php echo $form->dropDownList($model, 'search_year',BonusMonthForm::getYearList(),
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <?php echo $form->dropDownList($model, 'search_month',BonusMonthForm::getMonthList(),
                        ...
                        <div class="row panel panel-default" style="border-color: #333">
                            ...
                            <div class="panel-heading">
                                <h3 style="margin-top:10px;">
                                    <?php echo Yii::t('app','Bonus Month'); ?>
...
";
$ajaxUrl = Yii::app()->createUrl('bonusMonth/ajaxDetail');
$js.= "
