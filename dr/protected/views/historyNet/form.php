<?php
$this->pageTitle=Yii::app()->name . ' - HistoryNet Form';
?>
...
<section class="content-header">
	<h1>
        <strong><?php echo Yii::t('app','History Net'); ?></strong>
                        ...
                        <div class="row panel panel-default" style="border-color: #333">
                            ...
                            <div class="panel-heading">
                                <h3 style="margin-top:10px;">
                                    <?php echo Yii::t('app','History Net'); ?>
...
$js="
    $('.click-th').click(function(){
        ...
        if($(this).hasClass('active')){
            ...
            $('#historyNet>thead>tr').eq(0).children().slice(startNum,endNum).each(function(){
                var width = $(this).data('width')+'px';
                $(this).width(width);
            });
            $('#historyNet>thead>tr').eq(2).children().slice(startNum-contNum,endNum-contNum).each(function(){
                $(this).children('span').text($(this).data('text'));
            });
            $('#historyNet>tbody>tr').each(function(){
