<tr class='clickable-row' data-href='<?php echo $this->getLink('A11', 'serviceID/edit', 'serviceID/view', array('index'=>$this->record['id']));?>'>
	<td><?php echo $this->drawEditButton('A11', 'serviceID/edit', 'serviceID/view', array('index'=>$this->record['id']));?></td>
