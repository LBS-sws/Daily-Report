<?php
$this->pageTitle=Yii::app()->name . ' - ComparisonKA Form';
?>

<?php $form=$this->beginWidget('TbActiveForm', array(
'id'=>'ComparisonKA-form',
...
<section class="content-header">
	<h1>
        <strong><?php echo Yii::t('app','KA Comparison'); ?></strong>
...
<section class="content">
	...
	<div class="btn-group" role="group">
		<?php echo TbHtml::button('<span class="fa fa-reply"></span> '.Yii::t('misc','Back'), array(
				'submit'=>Yii::app()->createUrl('comparisonKA/index')));
		?>
	</div>
            <div class="btn-group pull-right" role="group">
                <?php echo TbHtml::button('<span class="fa fa-download"></span> '.Yii::t('dialog','Download'), array(
                    'submit'=>Yii::app()->createUrl('comparisonKABak/downExcel')));
                ?>
            </div>
	</div></div>
                        ...
                        <div class="row panel panel-default" style="border-color: #333">
                            ...
                            <div class="panel-heading">
                                <h3 style="margin-top:10px;">
                                    <?php echo Yii::t('app','KA Comparison'); ?>
...
";
$ajaxUrl = Yii::app()->createUrl('comparisonKA/ajaxDetail');
$js.= "
...
$ajaxUrl = Yii::app()->createUrl('comparisonBak/ajaxOffice');
$js="
$(function(){
    var cityList=[];
