...
<section class="content-header">
	<h1>
		<strong><?php echo Yii::t('app','KA Comparison Bak'); ?></strong>
	</h1>
<!--
	<ol class="breadcrumb">
...
<section class="content">
	...
	<div class="btn-group" role="group">
        <?php echo TbHtml::button('<span class="fa fa-search"></span> '.Yii::t('summary','Enquiry'), array(
            'submit'=>Yii::app()->createUrl('comparisonKABak/view')));
        ?>
	</div>
	</div></div>
	...
	<div class="box box-info">
		<div class="box-body">
            ...
            <!--查询說明-->
            <?php $this->renderPartial('//comparison/indexNote1'); ?>
		</div>
	</div>
</section>
...
$js = Script::genDatePicker(array(
    'ComparisonKAForm_search_start_date',
    'ComparisonKAForm_search_end_date'
));
