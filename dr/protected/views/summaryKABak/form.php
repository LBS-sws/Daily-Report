<?php
$this->pageTitle=Yii::app()->name . ' - SummaryKA Form';
?>
...
<section class="content">
	...
	<div class="btn-group" role="group">
		<?php echo TbHtml::button('<span class="fa fa-reply"></span> '.Yii::t('misc','Back'), array(
				'submit'=>Yii::app()->createUrl('summaryKABak/index')));
		?>
	</div>
            <div class="btn-group pull-right" role="group">
                <?php echo TbHtml::button('<span class="fa fa-download"></span> '.Yii::t('dialog','Download'), array(
                    'submit'=>Yii::app()->createUrl('summaryKABak/downExcel')));
                ?>
            </div>
	</div></div>
...
";
$ajaxUrl = Yii::app()->createUrl('summaryKA/ajaxDetail');
$js.= "
...
$ajaxUrl = Yii::app()->createUrl('summaryBak/ajaxOffice');
$js="
$(function(){
    var cityList=[];
