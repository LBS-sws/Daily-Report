<tr class='clickable-row <?php echo $this->record['color']; ?>' data-href='<?php echo $this->getLink('CW01', 'crossApply/edit', 'crossApply/view', array('index'=>$this->record['id']));?>'>
	<td><?php echo $this->drawEditButton('CW01', 'crossApply/edit', 'crossApply/view', array('index'=>$this->record['id'])); ?></td>
