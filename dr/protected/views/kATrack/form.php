<?php
$this->pageTitle=Yii::app()->name . ' - KATrack Form';
?>
...
<section class="content-header">
	<h1>
        <strong><?php echo Yii::t('app','KA Tracking'); ?></strong>
                        ...
                        <div class="row panel panel-default" style="border-color: #333">
                            ...
                            <div class="panel-heading">
                                <h3 style="margin-top:10px;">
                                    <?php echo Yii::t('app','KA Tracking'); ?>
...
";
$ajaxUrl = Yii::app()->createUrl('kATrack/ajaxDetail');
$js.= "
