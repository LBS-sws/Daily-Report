<?php
$this->pageTitle=Yii::app()->name . ' - RetentionRate Form';
?>

<?php $form=$this->beginWidget('TbActiveForm', array(
'id'=>'RetentionRate-form',
...
<section class="content-header">
	<h1>
        <strong><?php echo Yii::t('app','Retention rate'); ?></strong>
...
<section class="content">
	...
	<div class="btn-group" role="group">
		<?php echo TbHtml::button('<span class="fa fa-reply"></span> '.Yii::t('misc','Back'), array(
				'submit'=>Yii::app()->createUrl('retentionRate/index')));
		?>
	</div>
            <div class="btn-group pull-right" role="group">
                <?php echo TbHtml::button('<span class="fa fa-download"></span> '.Yii::t('dialog','Download'), array(
                    'submit'=>Yii::app()->createUrl('retentionRate/downExcel')));
                ?>
            </div>
	</div></div>
                ...
                <div class="box-body" >
                    <div class="col-lg-5">
                        <div class="form-group">
                            ...
                            <div class="col-lg-7">
                                <?php echo $form->dropDownList($model, 'search_year',RetentionRateForm::getRetentionYear(),
                                    array('readonly'=>true)
                                ); ?>
                            </div>
                        </div>
                        ...
                        <div class="row panel panel-default" style="border-color: #333">
                            ...
                            <div class="panel-heading">
                                <h3 style="margin-top:10px;">
                                    <?php echo Yii::t('app','Retention rate'); ?>
                            ...
                            <div class="table-responsive">
                                <?php echo $model->retentionRateHtml();?>
                            </div>
                        </div>
                    </div>
                </div>
...
";
$ajaxUrl = Yii::app()->createUrl('retentionRate/ajaxDetail');
$js.= "
