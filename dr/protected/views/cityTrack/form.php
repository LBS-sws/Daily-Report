<?php
$this->pageTitle=Yii::app()->name . ' - CityTrack Form';
?>
...
<section class="content-header">
	<h1>
		<strong><?php echo Yii::t('app','City Track Set'); ?></strong>
	</h1>
<!--
	<ol class="breadcrumb">
		...
		<?php 
			if ($model->scenario!='new' && $model->scenario!='view') {
				echo TbHtml::button('<span class="fa fa-file-o"></span> '.Yii::t('misc','Add Another'), array(
					'submit'=>Yii::app()->createUrl('cityTrack/new')));
			}
		?>
		<?php echo TbHtml::button('<span class="fa fa-reply"></span> '.Yii::t('misc','Back'), array(
				'submit'=>Yii::app()->createUrl('cityTrack/index'))); 
		?>
<?php if ($model->scenario!='view'): ?>
			<?php echo TbHtml::button('<span class="fa fa-upload"></span> '.Yii::t('misc','Save'), array(
				'submit'=>Yii::app()->createUrl('cityTrack/save'))); 
			?>
<?php endif ?>
...
<?php endif ?>
	...
	<div class="box box-info">
		<div class="box-body">
            ...
            <?php endif ?>
                <div class="form-group">
                    <?php echo $form->labelEx($model,'end_name',array('class'=>"col-sm-2 control-label")); ?>
                    <div class="col-sm-3">
                        <?php echo $form->textField($model, 'end_name',
...
$js = Script::genDeleteData(Yii::app()->createUrl('cityTrack/delete'));
