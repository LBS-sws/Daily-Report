...
class ComparisonKABakController extends Controller
{
	public $function_id='G44';
	...
	public function accessRules()
	{
		return array(
			array('allow', 
				...
				'expression'=>array('ComparisonKABakController','allowReadWrite'),
			),
			array('allow', 
				'actions'=>array('index','view','downExcel','ajaxDetail'),
				'expression'=>array('ComparisonKABakController','allowReadOnly'),
			),
    ...
    public function actionAjaxDetail(){
        if(Yii::app()->request->isAjaxRequest) {//是否ajax请求
            ...
            $this->redirect(Yii::app()->createUrl('comparisonKABak/index'));
        }
    }

    public function actionDownExcel()
    {
        $model = new ComparisonKABakForm('view');
        if (isset($_POST['ComparisonKABakForm'])) {
            $model->attributes = $_POST['ComparisonKABakForm'];
	...
	{
		$model = new ComparisonKABakForm('index');
	...
	public static function allowReadWrite() {
		return Yii::app()->user->validRWFunction('G44');
	}
	
	public static function allowReadOnly() {
		return Yii::app()->user->validFunction('G44');
	}
}
