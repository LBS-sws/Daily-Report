...
class HistoryResumeForm extends CFormModel
{
	/* User Fields */
    ...
    public function retrieveData() {
        ...
        //本週數據
        $serviceWeek = CountSearch::getServiceForType($weekStartDate,$weekEndDate,$city_allow,"R");
        //上週數據
        $lastServiceWeek = CountSearch::getServiceForType($lastWeekStartDate,$lastWeekEndDate,$city_allow,"R");
        ...
        $session['historyResume_c01'] = $this->getCriteria();
        return true;
    }
    ...
    //顯示提成表的表格內容
    public function historyResumeHtml(){
        $html= '<table id="historyResume" class="table table-fixed table-condensed table-bordered table-hover">';
    ...
    public function downExcel($excelData){
        ...
        $excel->colTwo=1;
        $excel->SetHeaderTitle(Yii::t("app","History Resume")."（{$this->search_date}）");
        ...
        $excel->outExcel(Yii::t("app","History Resume"));
    }
}