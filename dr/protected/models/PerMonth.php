...
class PerMonth extends CFormModel
{
	/* User Fields */
            ...
            foreach ($list[$city] as $key=>$value){
                ...
                switch ($type){
                    ...
                    case 2://產品服務及上月的產品服務
                        ...
                        //查询的月份不需要减少，需要特别处理
                        if(key_exists($nextStr,$data)&&$nextStr!=$endDate){
    ...
    //顯示提成表的表格內容
    public function perMonthHtml(){
        $html= '<table id="perMonth" class="table table-fixed table-condensed table-bordered table-hover">';
    ...
    public static function perMonthNumber($number){
