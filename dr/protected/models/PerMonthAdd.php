...
class PerMonthAdd extends PerMonth
{
    public function retrieveData() {
        ...
        foreach ($citySetList as $cityRow){
            ...
            $defMoreList["last_average"]+=key_exists($city,$lastUInvMoney)?$lastUInvMoney[$city]["sum_money"]:0;
    ...
    public function downExcel($excelData){
        ...
        $excel->colTwo=1;
        $excel->SetHeaderTitle(Yii::t("summary","Per Month Add")."（{$this->search_date}）");
        ...
        $excel->outExcel(Yii::t("summary","Per Month Add"));
    }
}