...
//赋值
                $excel['c76']=round($c76,2);
                $excel['c77']=round($c77,2);
                $excel['c78']=round($c78,2);
                $excel['c79']=round($c79,2);
                $excel['c80']=round($c80,2);
                $excel['c81']=round($c81,2);
                $excel['c82']=round($c82,2);
                $excel['c83']=round($c83,2);
                $excel['c84']=round($c84,2);
                $excel['c85']=round($c85,2);
                $excel['c86']=round($c86,2);
                $excel['c88']=round($c88,2);
                $excel['c89']=round($c89,2);
                $excel['c90']=round($c90,2);
                $excel['c91']=round($b21,2);
                $excel['c92']=round($c92,2);
                $excel['c93']=round($c93,2);
                $excel['c94']=round($c94,2);
                $excel['c96']=round($c96,2);
                $excel['c97']=round($c97,2);
                $excel['c98']=round($c98,2);
                $excel['c99']=round($c99,2);
                $excel['c100']=round($c100,2);
                $excel['c102']=round($c102,2);
                $excel['c103']=round($c103,2);
                $excel['c104']=round($c104,2);
                $excel['c105']=round($c105,2);
                $excel['c106']=round($c106,2);
                $excel['c107']=round($c107,2);
                $excel['c108']=round($c108,2);
                $excel['c109']=round($c109,2);
                $excel['c110']=$c110;
                $excel['c111']=round($c111,2);
                $excel['c112']=round($c112,2);
                $excel['c113']=round($c113,2);
                $excel['c114']=round($c114,2);
                $excel['c115']=round($c115,2);
                $excel['c117']=round($c117,2);
                $excel['c118']=round($c118,2);
                $excel['c119']=round($c119,2);
                $excel['c120']=round($c120,2);
                $excel['c121']=round($c121,2);
                $excel['c122']=round($c122,2);
                $excel['c124']=round($c124,2);

                $excel['e76']=round($e76,2);
                $excel['e77']=round($e77,2);
                $excel['e78']=round($e78,2);
                $excel['e79']=round($e79,2);
                $excel['e80']=round($e80,2);
                $excel['e81']=round($e81,2);
                $excel['e82']=round($e82,2);
                $excel['e83']=round($e83,2);
                $excel['e84']=round($e84,2);
                $excel['e85']=round($e85,2);
                $excel['e86']=round($e86,2);
                $excel['e88']=round($e88,2);
                $excel['e89']=round($e89,2);
                $excel['e90']=round($e90,2);
                $excel['e91']=round($e91,2);
                $excel['e92']=round($e92,2);
                $excel['e93']=round($e93,2);
                $excel['e94']=round($e94,2);
                $excel['e96']=round($e96,2);
                $excel['e97']=round($e97,2);
                $excel['e98']=round($e98,2);
                $excel['e99']=round($e99,2);
                $excel['e100']=round($e100,2);
                $excel['e102']=round($e102,2);
                $excel['e103']=round($e103,2);
                $excel['e104']=round($e104,2);
                $excel['e105']=round($e105,2);
                $excel['e106']=round($e106,2);
                $excel['e107']=round($e107,2);
                $excel['e108']=round($e108,2);
                $excel['e109']=round($e109,2);
                $excel['e110']=round($e110,2);
                $excel['e111']=round($e111,2);
                $excel['e112']=round($e112,2);
                $excel['e113']=round($e113,2);
                $excel['e114']=round($e114,2);
                $excel['e115']=round($e115,2);
                $excel['e117']=round($e117,2);
                $excel['e118']=round($e118,2);
                $excel['e119']=round($e119,2);
                $excel['e120']=round($e120,2);
                $excel['e121']=round($e121,2);
                $excel['e122']=round($e122,2);
                $excel['e124']=round($e124,2);
