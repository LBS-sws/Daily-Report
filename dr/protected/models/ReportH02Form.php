...
//赋值
                $excel['c76']=(round($c76,2)*100)."%";
                $excel['c77']=(round($c77,2)*100)."%";
                $excel['c78']=(round($c78,2)*100)."%";
                $excel['c79']=(round($c79,2)*100)."%";
                $excel['c80']=(round($c80,2)*100)."%";
                $excel['c81']=(round($c81,2)*100)."%";
                $excel['c82']=(round($c82,2)*100)."%";
                $excel['c83']=(round($c83,2)*100)."%";
                $excel['c84']=(round($c84,2)*100)."%";
                $excel['c85']=(round($c85,2)*100)."%";
                $excel['c86']=(round($c86,2)*100)."%";
                $excel['c88']=(round($c88,2)*100)."%";
                $excel['c89']=(round($c89,2)*100)."%";
                $excel['c90']=round($c90,2);
                $excel['c91']=(round($c91,2)*100)."%";
                $excel['c92']=(round($c92,2)*100)."%";
                $excel['c93']=(round($c93,2)*100)."%";
                $excel['c94']=round($c94,2);
                $excel['c96']=(round($c96,2)*100)."%";
                $excel['c97']=(round($c97,2)*100)."%";
                $excel['c98']=(round($c98,2)*100)."%";
                $excel['c99']=round($c99,2);
                $excel['c100']=(round($c100,2)*100)."%";
                $excel['c102']=(round($c102,2)*100)."%";
                $excel['c103']=(round($c103,2)*100)."%";
                $excel['c104']=(round($c104,2)*100)."%";
                $excel['c105']=$c105;
                $excel['c106']=(round($c106,2)*100)."%";
                $excel['c107']=(round($c107,2)*100)."%";
                $excel['c108']=(round($c108,2)*100)."%";
                $excel['c109']=(round($c109,2)*100)."%";
                $excel['c110']=$c110;
                $excel['c111']=(round($c111,2)*100)."%";
                $excel['c112']=(round($c112,2)*100)."%";
                $excel['c113']=(round($c113,2)*100)."%";
                $excel['c114']=(round($c114,2)*100)."%";
                $excel['c115']=(round($c115,2)*100)."%";
                $excel['c117']=(round($c117,2)*100)."%";
                $excel['c118']=(round($c118,2)*100)."%";
                $excel['c119']=(round($c119,2)*100)."%";
                $excel['c120']=(round($c120,2)*100)."%";
                $excel['c121']=(round($c121,2)*100)."%";
                $excel['c122']=(round($c122,2)*100)."%";
                $excel['c124']=(round($c124,2)*100)."%";
